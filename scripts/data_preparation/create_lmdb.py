...
def create_lmdb_for_revide():
    ...
    """
    # train_sharp
    folder_path = r'D:\VideoDehazing\Data\REVIDE_indoor\Train\gt'
    lmdb_path = 'datasets/REVIDE/train_gt.lmdb'
    img_path_list, keys = prepare_keys_revide(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # train_sharp_bicubic
    folder_path = 'D:\VideoDehazing\Data\REVIDE_indoor\Train\hazy'
    lmdb_path = 'datasets/REDS/train_hazy.lmdb'
    img_path_list, keys = prepare_keys_revide(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)


def prepare_keys_revide(folder_path):
    """Prepare image path list and keys for REDS dataset.
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        default='REVIDE',
        help=("Options: 'DIV2K', 'REDS', 'Vimeo90K', 'REVIDE' "
