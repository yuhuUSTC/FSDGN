...
from basicsr.utils.deconv import FastDeconv
...
class AECRNet(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=64, use_dropout=False, padding_type='reflect'):
        ...
        ###### FFA blocks
        # self.block1 = DehazeBlock(default_conv, ngf * 4, 3)
        # self.block2 = DehazeBlock(default_conv, ngf * 4, 3)
        # self.block3 = DehazeBlock(default_conv, ngf * 4, 3)
        # self.block4 = DehazeBlock(default_conv, ngf * 4, 3)
        # self.block5 = DehazeBlock(default_conv, ngf * 4, 3)
        # self.block6 = DehazeBlock(default_conv, ngf * 4, 3)
